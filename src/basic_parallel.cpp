...
int main(int argc, char **argv)
{
	...
	ofstream myfile;
	myfile.open ("adaptive_median_filter_bp_runtimes.txt",ios::app);
   ...
   myfile << image_name << " after " << " adaptive median filter (Basic Parallel with thread_count = "<< thread_count << ") takes "<<  elapsed_seconds.count()  << " seconds\n";
	myfile.close();
